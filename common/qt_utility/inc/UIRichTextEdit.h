...
class UIRichTextEdit : public QWidget
{
    Q_OBJECT
  public:
    UIRichTextEdit(QWidget *parent = 0);
  ...
  protected slots:
    ...
    void onSetPageBackgroundColor();
    void onIncreaseFontSize();
    void onDecreaseFontSize();
    void onButtonColorChanged(QToolButton * button,
